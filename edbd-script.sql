...
go
select * 
from student /* comments everything after and between those symboles with the * on the inside of the slashes
multiple lines until it is closed out by */
order by gpa >= 3 and gpa <= 3.25--comments the rest of the line without effecting script 
order by gpa desc;
